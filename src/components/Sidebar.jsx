                ...
                <Box width="100%">
                    ...
                    <FlexBetween color={theme.palette.secondary.main}>
                        <Box display="flex" alignItems="center" gap="0.5rem" justifyContent="center">
                            <Typography variant='h4' fontWeight="bold">VITERI ADMIN</Typography>
                        </Box>
                        {!isNonMobile && (
                    ...
                    {navItems.map(({text, icon}) => {
                        ...
                        return (
                            <ListItem key={text} disablePadding>
                                ...
                                sx={{backgroundColor: active === lcText ? theme.pallete.primary[300] : 'transparent',
                                     color: active === lcText ? theme.pallete.primary[600] : theme.palette.secondary[100] }}>
                                 <ListItemIcon
                                 sx={{ml: "2rem", color: active === lcText ? theme.pallete.primary[600] : theme.palette.secondary[200]}}
                                 >
                                  {icon}
                                 </ListItemIcon>
